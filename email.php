...
function goHome($status, $msg) {
    $msg = urlencode($msg);
    header("Location: https://bestivfdoctor.in/?status=$status&msg=$msg");
    exit;
}
...
<div style="background:#f0f3f8; padding:25px; font-family:Arial, sans-serif;">
    ...
    ">
        ...
        <p style="color:#333; margin-top:0; font-size:15px;">
            You received a new enquiry from <b>bestivfdoctor.in</b>.
        </p>
        ...
        <p style="margin-top:25px; font-size:12px; color:#777;">
            This email was automatically generated by the Best IVF website.
        </p>
    </div>
</div>
';
...
try {
    $mail->isSMTP();
    $mail->Host       = 'mail.bestivfdoctor.in';
    $mail->SMTPAuth   = true;
    $mail->Username   = 'info@bestivfdoctor.in';
    $mail->Password   = '[]tk{)s1rkH%';
